...
- 私の地理院地図（国土地理院が運営しているもの）：http://maps.gsi.go.jp/
- 私の地理院地図（本レポジトリを用いたデモ）：http://gsi-cyberjapan.github.io/gsimaps/
...
- 本レポジトリで提供しているのは、国土地理院が運営する「私の地理院地図」http://maps.gsi.go.jp/ のソースです。
